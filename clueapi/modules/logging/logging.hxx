...
namespace clueapi::modules::logging {
    ...
    class c_logging {
      public:
        CLUEAPI_INLINE c_logging() = default;

        CLUEAPI_INLINE ~c_logging() { destroy(); }
      ...
      public:
         ...
         */
        CLUEAPI_INLINE const auto is_running(std::memory_order m = std::memory_order_relaxed) const {
         ...
         */
        CLUEAPI_INLINE void set_default_level(e_log_level level) { m_cfg.m_default_level = level; }
         ...
         */
        CLUEAPI_INLINE const auto& default_level() const { return m_cfg.m_default_level; }
