...
namespace clueapi::modules::logging {
    ...
    namespace detail {
         ...
         */
        struct base_logger_t {
            CLUEAPI_INLINE base_logger_t() = default;
             ...
             */
            CLUEAPI_INLINE base_logger_t(logger_params_t params)
                : m_params{std::move(params)}, m_buffer{m_params.m_capacity}, m_enabled{true} {}

            CLUEAPI_INLINE virtual ~base_logger_t() = default;
          ...
          public:
             ...
             */
            CLUEAPI_INLINE void set_enabled(bool enabled) { m_enabled = enabled; }
             ...
             */
            CLUEAPI_INLINE void set_level(e_log_level level) { m_params.m_level = level; }
             ...
             */
            CLUEAPI_INLINE void set_capacity(std::size_t capacity) { m_buffer.set_capacity(capacity); }
             ...
             */
            CLUEAPI_INLINE void set_batch_size(std::size_t batch_size) { m_params.m_batch_size = batch_size; }
             ...
             */
            CLUEAPI_INLINE void set_async_mode(bool async_mode) {
             ...
             */
            CLUEAPI_INLINE auto& buffer() { return m_buffer; }

            /**
             * @brief Gets the logger's message buffer.
             * @return A const reference to the message buffer.
             */
            CLUEAPI_INLINE const auto& buffer() const { return m_buffer; }
             ...
             */
            CLUEAPI_INLINE const auto& async_mode() const { return m_params.m_async_mode; }

            /**
             * @brief Checks if the logger is enabled.
             * @return `true` if enabled, `false` otherwise.
             */
            CLUEAPI_INLINE const auto& enabled() const { return m_enabled; }

            /**
             * @brief Gets the name of the logger.
             * @return The logger's name.
             */
            CLUEAPI_INLINE const auto& name() const { return m_params.m_name; }

            /**
             * @brief Gets the log level of the logger.
             * @return The logger's log level.
             */
            CLUEAPI_INLINE const auto& level() const { return m_params.m_level; }
          ...
          private:
             ...
             */
            CLUEAPI_INLINE void set_prv_params(prv_logger_params_t prv_params) { m_prv_params = std::move(prv_params); }
