...
namespace clueapi::modules::logging::detail {
     ...
     * @internal
     */
    CLUEAPI_INLINE void print(batch_memory_buffer_t& buffer) {
     ...
     * @internal
     */
    CLUEAPI_INLINE void print(fmt::memory_buffer& buffer) {
        fmt::print(FMT_COMPILE("{}"), std::string_view(buffer.data(), buffer.size()));
     ...
     * @internal
     */
    CLUEAPI_INLINE void print(std::ofstream& file, batch_memory_buffer_t& buffer, bool flush = true) {
     ...
     * @internal
     */
    CLUEAPI_INLINE void print(std::ofstream& file, fmt::memory_buffer& buffer, bool flush = true) {
        file.write(buffer.data(), buffer.size());
     ...
     * @internal
     */
    CLUEAPI_INLINE bool format(const log_msg_t& msg, batch_memory_buffer_t& buffer) {
        ...
        fmt::format_to(
            ...
            fmt::styled(*std::localtime(&in_time_t), fmt::emphasis::bold | fg(fmt::rgb(245, 245, 184))),
     ...
     * @internal
     */
    CLUEAPI_INLINE bool format(const log_msg_t& msg, fmt::memory_buffer& buffer) {
        auto in_time_t = std::chrono::system_clock::to_time_t(msg.m_time);
