...
namespace clueapi::modules::logging::detail {
     ...
     */
    struct msg_buffer_t {
        CLUEAPI_INLINE msg_buffer_t() : m_capacity{512} { m_buf.reserve(m_capacity); }

        CLUEAPI_INLINE msg_buffer_t(std::size_t capacity) : m_capacity{capacity} { m_buf.reserve(m_capacity); }

        CLUEAPI_INLINE ~msg_buffer_t() = default;
      ...
      public:
         ...
         *
         * @return A pair containing a boolean indicating success and the original message if the buffer was full.
         */
      ...
      public:
         ...
         */
        CLUEAPI_INLINE void clear() { m_buf.clear(); }
      ...
      public:
         ...
         */
        CLUEAPI_INLINE void set_capacity(std::size_t capacity) { m_capacity = capacity; }
         ...
         * @return The capacity.
         */
        CLUEAPI_INLINE const auto& capacity() const { return m_capacity; }
         ...
         */
        CLUEAPI_INLINE const auto size() const {
         ...
         */
        CLUEAPI_INLINE const auto empty() const {
            std::shared_lock<std::shared_mutex> lock{m_mutex};
