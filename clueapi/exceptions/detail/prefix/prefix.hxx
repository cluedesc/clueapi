...
namespace clueapi::exceptions::detail {
     ...
     *
     * @tparam _size_t The size of the string literal array (including the null terminator).
     *
    ...
    struct prefix_holder_t {
         ...
         */
        CLUEAPI_INLINE constexpr prefix_holder_t() = default;

        /**
         * @brief Returns the content as a `std::string_view`.
         */
        CLUEAPI_INLINE constexpr prefix_holder_t(const char (&str)[_size]) {
      ...
      public:
        ...
        CLUEAPI_INLINE constexpr operator std::string_view() const { return view(); }

        CLUEAPI_INLINE constexpr auto operator<=>(const prefix_holder_t&) const = default;

      public:
        /**
         * @brief Returns the content as a `std::string_view`.
         */
        CLUEAPI_INLINE constexpr std::string_view view() const {
