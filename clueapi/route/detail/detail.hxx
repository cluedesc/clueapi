...
namespace clueapi::route::detail {
    ...
    struct radix_node_t {
         ...
         */
        CLUEAPI_INLINE bool is_dynamic() const { return !m_param_name.empty(); }
    ...
    template <typename _type_t>
    struct radix_tree_t {
        CLUEAPI_INLINE radix_tree_t() : m_root{std::make_shared<radix_node_t<_type_t>>()} {}
      ...
      public:
         ...
         */
        static http::types::path_t norm_path(const http::types::path_t& path);
         ...
         */
        static std::vector<std::string_view> split_path_segments(std::string_view path);
         ...
         */
        static std::string_view extract_param_name(std::string_view segment);
         ...
         */
        static bool is_dynamic_segment(std::string_view segment);
         ...
         */
        static bool is_broken_segment(std::string_view segment);
