...
namespace clueapi::http::chunks {
    exceptions::expected_awaitable_t<> chunk_writer_t::write_chunk(std::string_view data) {
        m_buffer.clear();
    ...
    exceptions::expected_awaitable_t<> chunk_writer_t::write_final_chunk() {
        ...
        co_return co_await exceptions::wrap_awaitable(
            boost::asio::async_write(
                ...
                boost::asio::buffer(k_final_chunk, k_final_chunk_size),
