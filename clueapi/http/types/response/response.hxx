...
namespace clueapi::http::types {
    ...
    struct base_response_t {
         ...
         */
        using stream_fn_t = std::function<exceptions::expected_awaitable_t<void>(chunks::chunk_writer_t&)>;

      public:
        CLUEAPI_INLINE constexpr base_response_t() = default;

        CLUEAPI_INLINE virtual ~base_response_t() = default;
      ...
      public:
         ...
         */
        CLUEAPI_INLINE
        base_response_t(body_t body, status_t::e_status status = status_t::e_status::ok, headers_t headers = {}) {
      ...
      public:
         ...
         */
        CLUEAPI_INLINE exceptions::expected_t<void> set_cookie(cookie_t cookie) {
      ...
      protected:
         ...
         *
         * @param headers The headers to merge. Existing headers with the same key will be overwritten.
         */
        CLUEAPI_INLINE void merge_headers(headers_t&& headers) {
            for (auto&& it : headers)
                m_headers[std::move(it.first)] = std::move(it.second);
        }
      ...
      public:
         ...
         */
        CLUEAPI_INLINE auto& body() { return m_body; }
         ...
         */
        CLUEAPI_INLINE const auto& body() const { return m_body; }
         ...
         */
        CLUEAPI_INLINE auto& headers() { return m_headers; }
         ...
         */
        CLUEAPI_INLINE const auto& headers() const { return m_headers; }
         ...
         */
        CLUEAPI_INLINE auto& cookies() { return m_cookies; }
         ...
         */
        CLUEAPI_INLINE const auto& cookies() const { return m_cookies; }
         ...
         */
        CLUEAPI_INLINE auto& status() { return m_status; }
         ...
         */
        CLUEAPI_INLINE const auto& status() const { return m_status; }
         ...
         */
        CLUEAPI_INLINE auto& stream_fn() { return m_stream_fn; }
         ...
         */
        CLUEAPI_INLINE const auto& stream_fn() const { return m_stream_fn; }
         ...
         */
        CLUEAPI_INLINE auto& is_stream() { return m_is_stream; }
         ...
         */
        CLUEAPI_INLINE const auto& is_stream() const { return m_is_stream; }
      ...
      public:
         ...
         */
        CLUEAPI_INLINE auto&& move_body() { return std::move(m_body); }
    ...
    struct html_response_t : base_response_t {
        CLUEAPI_INLINE constexpr html_response_t() = default;

        CLUEAPI_INLINE
        html_response_t(html_t body, status_t::e_status status = status_t::e_status::ok, headers_t headers = {}) {
            m_body = std::move(body);
    ...
    struct redirect_response_t : base_response_t {
        CLUEAPI_INLINE constexpr redirect_response_t() = default;

        CLUEAPI_INLINE redirect_response_t(
            std::string location, status_t::e_status status = status_t::e_status::found, headers_t headers = {}
        ) {
            m_body = "";

            if (status != status_t::e_status::moved_permanently && status != status_t::e_status::found
                && status != status_t::e_status::see_other && status != status_t::e_status::temporary_redirect
                && status != status_t::e_status::permanent_redirect)
                status = status_t::e_status::found;
    ...
    struct text_response_t : public base_response_t {
        CLUEAPI_INLINE constexpr text_response_t() = default;

        CLUEAPI_INLINE
        text_response_t(body_t body, status_t::e_status status = status_t::e_status::ok, headers_t headers = {}) {
            m_body = std::move(body);
    ...
    struct json_response_t : public base_response_t {
        CLUEAPI_INLINE constexpr json_response_t() = default;

        CLUEAPI_INLINE
        json_response_t(body_t body, status_t::e_status status = status_t::e_status::ok, headers_t headers = {}) {
    ...
    struct file_response_t : public base_response_t {
        CLUEAPI_INLINE file_response_t() = default;

        file_response_t(
            boost::filesystem::path path, status_t::e_status status = status_t::e_status::ok, headers_t headers = {}
        );
    };
    ...
    struct stream_response_t : public base_response_t {
        CLUEAPI_INLINE constexpr stream_response_t() = default;

        CLUEAPI_INLINE stream_response_t(
            stream_fn_t stream_fn, std::string content_type = "application/octet-stream",
            status_t::e_status status = status_t::e_status::ok, headers_t headers = {}
        ) {
    ...
    struct response_class_t {
      ...
      public:
        CLUEAPI_INLINE constexpr response_class_t() = default;
        ...
        CLUEAPI_INLINE static _class_t make(
            ...
            status_t::e_status status_code = status_t::e_status::ok,
