...
TEST_F(request_tests, initial_state) {
    EXPECT_EQ(req.method(), clueapi::http::types::method_t::e_method::unknown);
...
TEST_F(request_tests, accessors) {
    req.method() = clueapi::http::types::method_t::e_method::post;

    EXPECT_EQ(req.method(), clueapi::http::types::method_t::e_method::post);
