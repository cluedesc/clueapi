...
TEST_F(multipart_parser_tests, parse_single_in_memory_file) {
    run_test([this]() -> boost::asio::awaitable<void> {
        ...
        auto body = create_multipart_body(boundary_, {{"field1", "value1"}}, {{"file1", {"test.txt", file_content}}});

        parser_t::cfg_t cfg{
            .m_boundary = boundary_, .m_max_file_size_in_memory = 1024, .m_max_files_size_in_memory = 2048
        };
...
TEST_F(multipart_parser_tests, parse_file_spills_to_disk_on_size_limit) {
    run_test([this]() -> boost::asio::awaitable<void> {
        ...
        auto body = create_multipart_body(boundary_, {}, {{"largefile", {"large.txt", large_file_content}}});

        parser_t::cfg_t cfg{
            .m_boundary = boundary_, .m_max_file_size_in_memory = 100, .m_max_files_size_in_memory = 1024
        };
...
TEST_F(multipart_parser_tests, parse_spills_subsequent_files_on_total_size_limit) {
    run_test([this]() -> boost::asio::awaitable<void> {
        ...
        parser_t::cfg_t cfg{
            .m_boundary = boundary_, .m_max_file_size_in_memory = 100, .m_max_files_size_in_memory = 150
        };
...
TEST_F(multipart_parser_tests, parse_utf8_filename) {
    run_test([this]() -> boost::asio::awaitable<void> {
        ...
        auto body = create_multipart_body(boundary_, {}, {}, {{"utf8file", {utf8_filename_encoded, "content"}}});
...
TEST_F(multipart_parser_tests, parse_file_fails_on_unexpected_eof) {
    run_test([this]() -> boost::asio::awaitable<void> {
        ...
        EXPECT_NE(result.error().find("Part boundary not found for field, unexpected EOF"), std::string::npos);
    });
}